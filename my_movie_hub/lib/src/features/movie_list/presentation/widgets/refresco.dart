...
/// the same values passed into the [Refresco].
///
...
/// A callback function that's invoked when the [Refresco] is
/// pulled a `refreshTriggerPullDistance`. Must return a [Future]. Upon
/// completion of the [Future], the [Refresco] enters the
...
///    [Refresco] is part of the scrollable and actively occupies
///    scrollable space.
class Refresco extends StatefulWidget {
  ...
  static RefreshIndicatorMode state(BuildContext context) {
    final _RefrescoState state =
        context.findAncestorStateOfType<_RefrescoState>()!;
  ...
  @override
  State<Refresco> createState() => _RefrescoState();
}

class _RefrescoState extends State<Refresco> {
