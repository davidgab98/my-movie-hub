...
class PopularMoviesHorizontalList extends StatelessWidget {
  const PopularMoviesHorizontalList({super.key});

  @override
  Widget build(BuildContext context) {
    return PublicListSection(
      title: 'publicLists.popularTitle'.tr(),
      child: SimpleMovieList(
        fetchMovies: locator<PublicListsRepository>().getPopularMovies,
      ),
    );
  }
}
